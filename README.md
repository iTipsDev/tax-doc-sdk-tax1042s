# tax-doc-sdk-tax1042s

Software development kit to generate IRS Form 1042-S as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1042S.sample.png" width="850"/>
