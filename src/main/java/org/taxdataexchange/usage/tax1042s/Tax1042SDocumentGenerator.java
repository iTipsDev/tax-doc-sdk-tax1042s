...
import irs.fdxtax641.jsonserializers.Tax1042SSerializer;
import irs.fdxtax641.map2objects.Map2Tax1042S;
import org.taxdataexchange.core.pdfbuilders.Tax1042SPdfBuilder;
...
public class Tax1042SDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1042S obj = Map2Tax1042S.generate( row );
        {
            String asJson = Tax1042SSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1042S.csv";
        ...
        String outputFileName = "Tax1042S.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1042SDocumentGenerator generator = new Tax1042SDocumentGenerator( );
